        ...
        <div id="container">
            <div id="indexBackground">
                ...
                <div id="indexBackgroundTitle">
                    ...
                    <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=1');
                    $sub= $subtitle->fetch();?>
            ...
            <div class="index-container">
                <div class="text-container" id="scroll_ancre">
                    ...
                    <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=3');
                    $sub= $subtitle->fetch();?>
                ...
                <div class="formules">
                    ...
                    <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=63');
                    $sub= $subtitle->fetch();?>
                    <h2><?php echo $sub['texteContenu']; ?></h2>
                    ...
                    <div class="bouchons">
                       ...
                       <div class="description">
                           ...
                           <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=64');
                           $sub= $subtitle->fetch();?>
                           <h3><?php echo $sub['texteContenu']; ?></h3>


                           <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=14');
                           $sub= $subtitle->fetch();?>
                           <p><?php echo $sub['texteContenu']; ?></p>
                    ...
                    <div class="rougail">
                        <div class="description">
                            ...
                            <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=65');
                            $sub= $subtitle->fetch();?>
                            <p><?php echo $sub['texteContenu']; ?></p>


                            <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=15');
                            $sub= $subtitle->fetch();?>
                            <p><?php echo $sub['texteContenu']; ?></p>
                ...
                <div class="events">
                    <div class="title">
                        ...
                        <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=66');
                        $sub= $subtitle->fetch();?>
                        <h2><?php echo $sub['texteContenu']; ?></h2>

                        <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=67');
                        $sub= $subtitle->fetch();?>
                        <h3><?php echo $sub['texteContenu']; ?></h3>
                    ...
                    <div class="TextIntervention">
                        ...
                        <?php $subtitle= $bdd->query('SELECT texteId, texteContenu FROM texte WHERE texteId=68');
                        $sub= $subtitle->fetch();?>
                        <p><?php echo $sub['texteContenu']; ?></p>
